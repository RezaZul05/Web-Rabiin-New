...
<body>
  <main>
    ...
    <!-- Contact Start -->
    <section id="contact" style="background-color: darkgray;">
      <div class="wrapper" style="margin: 5%; position: relative;">
        <div class="gradient" style="position: absolute; width: 100%; height: 50%; bottom:0; left: 0; z-index: 2;">
        </div>
